...
public class IhmKanbanCallsCommImp implements IhmKanbanCallsComm {
    ...
    public void sendRequestModification(LightUser user, Modification modification) {
        ...
        LOGGER.log(Level.INFO, "Envoi demande de modification carte {0} vers {1} par {2}", new Object[]{modification.getId(), modification.getMyKanban().getTitle(), user.getUsername()});
